...
# device
$(call inherit-product-if-exists, device/samsung/t0lteatt/full_t0lteatt.mk)
...
PRODUCT_NAME := ukg_t0lteatt
PRODUCT_MODEL := Samsung Galaxy Note 2
PRODUCT_MANUFACTURER := Samsung
PRODUCT_PROPERTY_OVERRIDES += ro.buildzipid=ukg.t0lteatt.$(shell date +%m%d%y).$(shell date +%H%M%S)

# overrides
PRODUCT_BUILD_PROP_OVERRIDES += \
    BUILD_NUMBER=573038 \
    PRODUCT_NAME=t0lteatt \
    TARGET_BUILD_TYPE=user \
    BUILD_VERSION_TAGS=release-keys \
    PRIVATE_BUILD_DESC="t0lteatt-user 4.2.2 JDQ39 573038 release-keys" \
    BUILD_FINGERPRINT="samsung/t0lteatt:4.2.2/JDQ39/573038:user/release-keys"
